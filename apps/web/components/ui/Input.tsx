...
const GLASS_FIELD =
  "rounded-xl border border-white/70 bg-white/55 px-3 py-2 text-sm text-gray-900 backdrop-blur-sm transition-colors placeholder:text-gray-500 focus:border-brand-400 focus:bg-white/85 focus:outline-none focus:ring-2 focus:ring-brand-400/25";
